...
@section('body')
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="p-2">
                                    <form method="POST" class="form-horizontal mt-4" action="{{ route('register') }}"
                                        ...
                                        <div class="form-group" id="agencyName_div">
                                            <label for="agencyName">Agency Name</label>
                                            <input type="text"
                                                class="form-control @error('agencyName') is-invalid @enderror"
                                                value="{{ old('agencyName') }}" name="agencyName" id="agencyName"
    ...
    @section('script'){{-- 
        ...
        <script>
            $('#agencyName_div').css('display', 'none');
            $('#rne_div').css('display', 'none');
            $('#userType').change(function() {
                if ($('#userType')[0].options.selectedIndex == 4) {
                    $('#agencyName_div').css('display', 'block');
                    $('#rne_div').css('display', 'block');
                } else {
                    $('#agencyName_div').css('display', 'none');
                    $('#rne_div').css('display', 'none');
                    $('#agencyName_div').value=null;
                    $('#rne_div').value=null;
                }
            })
