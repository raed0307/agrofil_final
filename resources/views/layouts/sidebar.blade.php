            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <a href="{{ route('admin.users.index') }}" class="waves-effect">
                        <span>@lang('translation.ManageUsers')</span>
                    </a>
                    @endhasrole
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('clientsindex') }}">@lang('translation.Clients')</a></li>
                        <li><a href="{{ route('clientsCreateStepOne') }}">@lang('translation.AddClient')</a></li>
                    </ul>
                    @endhasrole
                </li>
